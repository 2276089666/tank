 ...
 */
public class TankChangeDirMessage extends AbstractMessage{
    private UUID id;
    private int x, y;
    private Direction direction;

    public TankChangeDirMessage() {
    }

    public TankChangeDirMessage(UUID id, int x, int y, Direction direction) {
        this.id = id;
        this.x = x;
        this.y = y;
    ...
    @Override
    public int getType() {
        return MessageType.TankChangeDirMessage.ordinal();
    }

    @Override
    public String toString() {
        return "TankChangeDirMessage{" +
                "id=" + id +
                ", x=" + x +
                ", y=" + y +
                ", direction=" + direction +
